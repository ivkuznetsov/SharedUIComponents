...
extension Table: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let item = item as? UITableViewCell {
            ...
            let tableCell = view.createCell(for: ContainerTableCell.self, source: .code(reuseId: "\(item.hash)"))
            ...
            cell = view.createCell(for: createCell.info.type, source: createCell.info.source)
